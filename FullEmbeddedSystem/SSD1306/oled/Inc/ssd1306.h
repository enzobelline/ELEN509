 ...
 */
typedef enum {
	SSD1306_COLOR_BLACK = 0x00U,  /*!< Black color, no pixel */
	SSD1306_COLOR_WHITE = 0x01U,  /*!< Pixel is set. Color depends on LCD */
        SSD1306_COLOR_BLUE  = 0x01U,  /*!< Pixel is set. Color depends on LCD */
        SSD1306_COLOR_YELLOW = 0x01U  /*!< Pixel is set. Color depends on LCD */
} SSD1306_COLOR_t;
